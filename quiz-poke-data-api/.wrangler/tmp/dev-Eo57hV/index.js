...
// .wrangler/tmp/bundle-HhMLey/checked-fetch.js
...
// .wrangler/tmp/bundle-HhMLey/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();
...
// .wrangler/tmp/bundle-HhMLey/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
var PokeData = class extends K {
  async handle() {
    const base_stat = await env.POKEMON_DATA.get("BASE_STAT");
    const responseData = [
      {
        id: 987,
        name: "\u30CF\u30D0\u30BF\u30AF\u30AB\u30DF",
...
var jsonError2 = async (request, env2, _ctx, middlewareCtx) => {
  try {
